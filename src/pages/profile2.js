  ...
  <body>
    ...
    <div class="card mb-3">
      ...
      <div class="card-body">
        ...
        <p class="card-text">
          <small class="text-muted">repos: {user2.public_repos}</small><br></br>
          <small class="text-muted">followers: {user2.followers}</small><br></br>
          <small class="text-muted">following: {user2.following}</small><br></br>
          <small class="text-muted">location: {user2.location}</small><br></br>
        </p>
